...
function lithestore_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
	    'shop_section',
	    array(
	        'title' => __('Shop Page','lithestore'),
	        'description' => __( 'You can manage the shop page with the following settings.','lithestore'),
	        'priority' => 20,
	...
	$wp_customize->add_control( 
	    new WP_Customize_Control( 
	      $wp_customize,
		  'control_shop_sidebar', 
		  array(  
		    'label' => __( 'Sidebar', 'lithestore' ),												 	
		    'section' => 'shop_section',
		    'settings' => 'shop_sidebar',
		    'type'	 => 'select',
		    'choices' => array(
		    	'right-sidebar' => esc_html__('Right Sidebar', 'lithestore'),
		    	'left-sidebar' => esc_html__('Left Sidebar', 'lithestore')
		    )
		 ) 
	   ) 
	);
	...
	$wp_customize->add_control( 
	    new WP_Customize_Control( 
	      $wp_customize,
		  'control_product_category_row', 
		  array(  
		    'label' => __( 'Show Product Category Section ', 'lithestore' ),										 	
		    'section' => 'home_section',
		    'settings' => 'product_category_row',
		    'type'	 => 'select',
		    'choices' => array(
		    	1 => esc_html__('Yes', 'lithestore'),
		    	0 => esc_html__('No', 'lithestore'),
		    )
		 ) 
	   ) 
	);
	...
	$wp_customize->add_control( 
	    new WP_Customize_Control( 
	      $wp_customize,
		  'control_featured_row', 
		  array(  
		    'label' => __( 'Show Featured Products Section ', 'lithestore' ),										 	
		    'section' => 'home_section',
		    'settings' => 'featured_row',
		    'type'	 => 'select',
		    'choices' => array(
		    	1 => esc_html__('Yes', 'lithestore'),
		    	0 => esc_html__('No', 'lithestore'),
	...
	$wp_customize->add_control( 
	    new WP_Customize_Control( 
	      $wp_customize,
		  'control_top_rated_row', 
		  array(  
		    'label' => __( 'Show Top Rated Section ', 'lithestore' ),										 	
		    'section' => 'home_section',
		    'settings' => 'top_rated_row',
		    'type'	 => 'select',
		    'choices' => array(
		    	1 => esc_html__('Yes', 'lithestore'),
		    	0 => esc_html__('No', 'lithestore'),
	...
	$wp_customize->add_control( 
	    new WP_Customize_Control( 
	      $wp_customize,
		  'control_recent_products_row', 
		  array(  
		    'label' => __( 'Show Recent Products Section ', 'lithestore' ),										
		    'section' => 'home_section',
		    'settings' => 'recent_products_row',
		    'type'	 => 'select',
		    'choices' => array(
		    	1 => esc_html__('Yes', 'lithestore'),
		    	0 => esc_html__('No', 'lithestore'),
	...
	$wp_customize->add_control( 
	    new WP_Customize_Control( 
		  ...
		  'control_onsale_row', 
		  array(  
		    'label' => __( 'Show On Sale Section ', 'lithestore' ),										
		    'section' => 'home_section',
		    'settings' => 'onsale_row',
		    'type'	 => 'select',
		    'choices' => array(
